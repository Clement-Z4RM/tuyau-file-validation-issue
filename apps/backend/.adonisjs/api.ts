...
type UsersPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/main.ts')['createUserValidator']>>
  response: MakeTuyauResponse<import('../app/controllers/users_controller.ts').default['store']>
}
type PostsGetHead = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/main.ts')['getPostsValidator']>>
  response: MakeTuyauResponse<import('../app/controllers/posts_controller.ts').default['index']>
}
type PostsPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/main.ts')['createPostValidator']>>
...
type PostsIdCommentsPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/main.ts')['createCommentValidator']>>
  response: MakeTuyauResponse<import('../app/controllers/comments_controller.ts').default['store']>
}
type FooPost = {
  request: MakeTuyauRequest<InferInput<typeof import('../app/validators/foo.ts')['fooValidator']>>
  response: MakeTuyauResponse<import('../app/controllers/foo_controller.ts').default['bar']>
}
